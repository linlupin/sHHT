#########################################################################
# To count for the IF of traditional HHT and sHHT of a linear chirp signal
#########################################################################
...
ff=h5py.File("linearchirp_disp.hdf5","w")   # output the result for a plot

data_noise_level=10.0                       # internal noise level of the data                       
amp = 10.0                                  # amplitude of the signal
#method='nht'         
method='hilbert'                            # methods to perform emd package
n=1000                                      # stack HHT for 1000 times
#input_noise_level=0.1  
input_noise_level=0.6                       # input noise level to perform sHHT
...
plt.ylabel('Frequency', fontsize=30)
plt.yticks(fontsize=20)
#plt.savefig('disp_linearchirp2.eps',format="eps", dpi=1200)
#plt.close(fig)
plt.show()
