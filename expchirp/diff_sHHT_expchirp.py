...
ff=h5py.File("expchirp_disp2.hdf5","w")    # output the result for a plot
...
plt.show()
#plt.savefig('diff_HHT_expchirp2.eps',format="eps", dpi=1200)
#plt.close(fig)
...
plt.ylabel('Frequency', fontsize=30)
plt.yticks(fontsize=20)
#plt.savefig('disp_expchirp2.eps',format="eps", dpi=1200)
#plt.close(fig)
plt.show()
